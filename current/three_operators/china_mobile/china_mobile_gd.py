...
class ChinaMobile_GD(object):
    ...
    def getCode(self, phone, pwd):
        ...
        try:
            ...
            user_name_element.send_keys(phone)
            browser.find_element_by_id('btn_get_dpw').click()
            print 'hi,动态验证码已经发送到手机:' + phone
    # def

    def login(self, browser, phone, pwd, note_pwd):
        ...
        dynamic_pw_element.send_keys(note_pwd)
        login_element.click()  # login after click
        browser.implicitly_wait(_time_usual)
    ...
    def clawAllInfo(self, browser):
        try:
            ...
            browser.implicitly_wait(ChinaMobile_GD.time_wait_special)
